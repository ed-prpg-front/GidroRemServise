...
let lowMenu = document.querySelector('.menu__submenu');
if (burgerMenu != null) {
   let menuBody = document.querySelector(".menu__body");
   burgerMenu.addEventListener("click", function (e) {
      burgerMenu.classList.toggle("_active");
      menuBody.classList.toggle("_active");
      lowMenu.classList.toggle('_active');
      console.log('active');
   });
};
function menu_close() {
   ...
   menuBody.classList.remove("_active");
   lowMenu.classList.remove('_active');
}

// Нижнее меню (menu-bottom)
let newBurger = document.querySelector('.menu__mobile-menu');
let dropDownMenu = document.querySelector('.menu__list');

if (newBurger != null) {
   newBurger.addEventListener('click', function (e) {
      newBurger.classList.toggle('_active');
      dropDownMenu.classList.toggle('_active');
      console.log('function newBurger');
   });
}

let closeItem = document.querySelector('.menu__close');
...
let servicesLink = document.querySelector('.menu__link_services');
...
// POPUP
let popupAsk = document.querySelector('.form-advantages__button');
let addAsk = document.querySelector('.popup_ask');

popupAsk.addEventListener('click', function (e) {
   addAsk.classList.add('_active');
});
